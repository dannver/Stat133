...
<div class="leftresults content grey">
  ...
  <div id="sidecaption">
  When broken down by weekday, results appear to be consistent.
  </div>
</div>
<div class="rightresults">
<img src="Rplot.png" width="100%" height="200">
<img src="Rplot2.png" width="100%" height="200">
<img src="Rplot3.png" width="100%" height="200">
</div>
</div>
